...
class DisciplinasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create disciplina" do
    assert_difference('Disciplina.count') do
      post disciplinas_url, params: { disciplina: { carga_horaria: @disciplina.carga_horaria, docente_id: @disciplina.docente_id, nome: @disciplina.nome } }
    end
  ...
  test "should update disciplina" do
    patch disciplina_url(@disciplina), params: { disciplina: { carga_horaria: @disciplina.carga_horaria, docente_id: @disciplina.docente_id, nome: @disciplina.nome } }
